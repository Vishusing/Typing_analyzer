...
if __name__ == "__main__":
    prompt = "Python is a high-level, interpreted programming language"
# this is the paragraph which you have to type to check your speed.
    ...
    # collect all the info returned by the functions
    ...
    print('Total time elapsedL', time ,'seconds')
